# Generated by Django 4.2.8 on 2024-01-22 17:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ownerships', to='project_first_app.car', verbose_name='Автомобиль')),
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ownerships', to='project_first_app.carowner', verbose_name='Владелец')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='licences', to='project_first_app.carowner', verbose_name='Владелец')),
            ],
            options={
